                    ...
                    <form action="{{ route('notulen.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="pembicara" id="pembicara"
                                class="form-control @error('pembicara') is-invalid @enderror" value="{{ old('pembicara') }}"
                                required>
                            @error('pembicara')
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="notulen" id="notulen" rows="6"
                                class="form-control @error('notulen') is-invalid @enderror"
