                                        ...
                                        <tbody>
                                            @forelse($pengajuan as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form action="{{ route('peminjaman.tanggapi', $item->id) }}" method="POST" class="d-flex flex-column gap-1">
                                                            @csrf
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center text-muted">Tidak ada pengajuan peminjaman.</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                                    <div class="d-flex justify-content-between mt-4">
                                        <a href="{{ route('perlengkapan.index') }}" class="btn btn-danger">Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </div>
